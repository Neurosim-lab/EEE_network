...
if cfg.noise and cfg.noisePT5:
    netParams.cellParams['PT5_1']['secs']['soma']['pointps'] = {
                        'noise': {'mod': 'Gfluctp', 
                        'loc': 0.5,
                        'std_e': 0.0030 * cfg.PT5_exc_noise_std * cfg.PT5_noise_std * cfg.noise_scale,
                        ...
                        'std_i': 0.0066 * cfg.PT5_inh_noise_std * cfg.PT5_noise_std * cfg.noise_scale, 
...
if cfg.noise and cfg.noisePV5:
    netParams.cellParams['PV5_1']['secs']['soma']['pointps'] = {
                        'noise': {'mod': 'Gfluctp', 
                        'loc': 0.5,
                        'std_e': 0.0030 * cfg.PV5_exc_noise_std * cfg.PV5_noise_std * cfg.noise_scale,
                        ...
                        'std_i': 0.0066 * cfg.PV5_inh_noise_std * cfg.PV5_noise_std * cfg.noise_scale, 
