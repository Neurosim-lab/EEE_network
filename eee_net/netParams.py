...
if cfg.noise and cfg.noisePT5:
    netParams.cellParams['PT5_1']['secs']['soma']['pointps'] = {
                        'noise': {'mod': 'Gfluctp', 
                        'loc': 0.5,
                        'std_e': 0.0030 * cfg.PT5_exc_noise_std * cfg.PT5_noise_std * cfg.noise_scale * cfg.noise_std_scale,
                        'g_e0' : 0.0121 * cfg.PT5_exc_noise_amp * cfg.PT5_noise_amp * cfg.noise_scale, 
                        'tau_i': 10.49 * cfg.PT5_inh_noise_tau, 
                        'tau_e': 2.728 * cfg.PT5_exc_noise_tau, 
                        'std_i': 0.0066 * cfg.PT5_inh_noise_std * cfg.PT5_noise_std * cfg.noise_scale * cfg.noise_std_scale, 
                        'g_i0' : 0.0573 * cfg.PT5_inh_noise_amp * cfg.PT5_noise_amp * cfg.noise_scale, 
...
if cfg.noise and cfg.noisePV5:
    netParams.cellParams['PV5_1']['secs']['soma']['pointps'] = {
                        'noise': {'mod': 'Gfluctp', 
                        'loc': 0.5,
                        'std_e': 0.0030 * cfg.PV5_exc_noise_std * cfg.PV5_noise_std * cfg.noise_scale * cfg.noise_std_scale,
                        'g_e0' : 0.0121 * cfg.PV5_exc_noise_amp * cfg.PV5_noise_amp * cfg.noise_scale, 
                        'tau_i': 10.49 * cfg.PV5_inh_noise_tau, 
                        'tau_e': 2.728 * cfg.PV5_exc_noise_tau, 
                        'std_i': 0.0066 * cfg.PV5_inh_noise_std * cfg.PV5_noise_std * cfg.noise_scale * cfg.noise_std_scale, 
                        'g_i0' : 0.0573 * cfg.PV5_inh_noise_amp * cfg.PV5_noise_amp * cfg.noise_scale, 
