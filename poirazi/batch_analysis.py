...
spikewidth   = 3.0
myoutputdir    = 'output'
mybatchdatadir = 'batch_data'    # output/batch_label/batch_data
mybatchfigdir  = 'batch_figures' # output/batch_label/batch_figures
...
def plot_vtraces(batchname, batchdatadir=None, cellIDs=None, secs=None, timerange=None, param_labels=None, title=None, filename=None, save=True, outputdir=None):
...
def plot_vtraces_multicell(batchname, cellIDs=None, secs=None, param_labels=None, celllabel=None, title=None, filename=None, save=True, outputdir=None):
...
def plot_antic_plateaus(batch="glutAmp", cellIDs=None, syntime=syntime, section="soma", voffset=20, hoffset=400, savefig=True, vertfig=False, outputdir=None):
...
def plot_plat_dur(batchname, cellIDs=None, platthresh=platthresh, stable=stable, syntime=syntime, recstep=recstep, param_labels=None, legend_label=None, title=None, savefig=True, swapaxes=False, showwork=False, outputdir=None, fig=None):
...
def plot_plat_amp(batchname, cellIDs=None, platthresh=platthresh, stable=stable, syntime=syntime, recstep=recstep, param_labels=None, legend_label=None, title=None, savefig=True, swapaxes=False, showwork=False, outputdir=None, fig=None):
...
def plot_num_spikes(batchname, cellIDs=None, platthresh=platthresh, stable=stable, syntime=syntime, recstep=recstep, param_labels=None, legend_label=None, title=None, savefig=True, swapaxes=False, showwork=False, outputdir=None, fig=None):
...
def plot_freq(batchname, cellIDs=None, platthresh=platthresh, stable=stable, syntime=syntime, recstep=recstep, param_labels=None, legend_label=None, title=None, savefig=True, swapaxes=False, showwork=False, outputdir=None, fig=None):
...
def plot_time_to_spike(batchname, cellIDs=None, platthresh=platthresh, stable=stable, syntime=syntime, recstep=recstep, param_labels=None, legend_label=None, title=None, savefig=True, swapaxes=False, showwork=False, outputdir=None, fig=None):
...
def plot_first_interspike(batchname, cellIDs=None, platthresh=platthresh, stable=stable, syntime=syntime, recstep=recstep, param_labels=None, legend_label=None, title=None, savefig=True, swapaxes=False, showwork=False, outputdir=None, fig=None):
...
def plot_baps(batchname, cellIDs=None, section="basal_34", outputdir=None, savefig=True):
...
def plot_plat_comps(batchname, cellIDs=None, expdata=False, platthresh=platthresh, stable=stable, syntime=syntime, recstep=recstep, outputdir=None, swapaxes=False, savefig=True):
